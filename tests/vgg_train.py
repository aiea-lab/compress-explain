...
for epoch in range(num_epochs):
    ...
    if loss < bst_loss:
        torch.save(model.state_dict(), '/persistentvol/compress-explain/saved_models/vgg_pretrain_best_{}.pt'.format(epoch))
        bst_loss = loss
        print('Saved best model to /persistentvol/compress-explain/saved_models/vgg_pretrain_best_{}.pt'.format(epoch))
