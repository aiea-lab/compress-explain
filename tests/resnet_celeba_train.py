...
for epoch in range(epochs):
    ...
    if loss < bst_loss:
        torch.save(model.state_dict(), '/persistentvol/compress-explain/saved_models/resnet34_pretrain_celeba_{}.pt'.format(epoch))
        bst_loss = loss
        print('Saved best model to /persistentvol/compress-explain/saved_models/resnet34_pretrain_celeba_{}.pt'.format(epoch))
torch.save(model.state_dict(), '/persistentvol/compress-explain/saved_models/resnet34_pretrain_celeba_latest.pt')
bst_loss = loss
print('Saved Latest model to /persistentvol/compress-explain/saved_models/resnet34_pretrain_celeba_latest.pt')
